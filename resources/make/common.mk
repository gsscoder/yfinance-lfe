...
ERL_LIBS=.:..:../yfinance-lfe:$(shell $(LFETOOL) info erllibs)
OS := $(shell uname -s)
ifeq ($(OS),Linux)
        HOST=$(HOSTNAME)
endif
...
get-version:
	...
	-eval "lfe_io:format(\"~p~n\",['yfinance-lfe-util':'get-versions'()])." \
...
install: compile
	@echo "Installing yfinance-lfe ..."
	@PATH=$(SCRIPT_PATH) lfetool install lfe

upload: $(EXPM) get-version
	@echo "Preparing to upload yfinance-lfe ..."
	@echo
	@echo "Package file:"
	@echo
	@cat package.exs
